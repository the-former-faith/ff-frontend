...
//import IconPng from "./Logo.png"

export default class Logo extends Component {
  componentWillMount() {
    if (typeof window !== 'undefined') { require('./../../functions/modernizr.min.js'); }
  }
  render() {
    let icon = null
    if (typeof window !== 'undefined' && Modernizr.inlinesvg) {
     icon = 
			<svg 
     ...
     //icon = <img src={ IconPng } alt={ this.props.title } />
    }
    return icon
  }
}
